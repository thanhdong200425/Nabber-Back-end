    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    return [2 /*return*/, new Error("Error hash password")];
...
var groupArray = function (arr, quantity) {
    var chunkedArray = {}, key = 1, length = arr.length, track = quantity;
    for (var i = 0; i < length; i += track) {
        if (i >= quantity)
            quantity += track;
